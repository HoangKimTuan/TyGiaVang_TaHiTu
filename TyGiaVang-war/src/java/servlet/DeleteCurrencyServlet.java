...
public class DeleteCurrencyServlet extends HttpServlet {
    ...
    protected void processRequest(HttpServletRequest request, HttpServletResponse response)
        ...
        String code_nt = request.getParameter("code_nt");
        ...
        currency = new Currency(id, code_nt, name, buy, transfer, sell);
        currencyFacade.remove(currency);
        
        response.sendRedirect("http://"+request.getServerName()+":"+request.getServerPort()+"/TyGiaVang-war/admin_views/admin_currency.jsp");
    }
